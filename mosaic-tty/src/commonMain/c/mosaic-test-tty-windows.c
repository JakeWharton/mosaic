...
MOSAIC_EXPORT uint32_t MOSAIC_STDCALL testTty_resize(MosaicTestTty *testTty, int columns, int rows, int width UNUSED, int height UNUSED) {
...
MOSAIC_EXPORT uint32_t MOSAIC_STDCALL testTty_sendKeyEvent(MosaicTestTty *testTty UNUSED) {
	// TODO
	return 0;
}

MOSAIC_EXPORT uint32_t MOSAIC_STDCALL testTty_sendMouseEvent(MosaicTestTty *testTty UNUSED) {
	// TODO
	return 0;
}
