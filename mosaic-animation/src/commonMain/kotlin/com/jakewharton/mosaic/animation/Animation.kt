...
/**
 * This interface provides a convenient way to query from an [com.jakewharton.mosaic.animation.VectorizedAnimationSpec] or
 * [com.jakewharton.mosaic.animation.FloatDecayAnimationSpec]: It spares the need to pass the starting conditions and in some cases
 ...
 * more lifecycle aware animations. In contrast, [com.jakewharton.mosaic.animation.Animatable] and [com.jakewharton.mosaic.animation.Transition] are stateful and
 * manage their own lifecycles.
 *
 * @see [com.jakewharton.mosaic.animation.Animatable]
 * @see [com.jakewharton.mosaic.animation.rememberTransition]
 * @see [com.jakewharton.mosaic.animation.updateTransition]
 */
public interface Animation<T, V : AnimationVector> {
	...
	/**
	 * The [com.jakewharton.mosaic.animation.TwoWayConverter] that will be used to convert value/velocity from any arbitrary data
 ...
 * interruption handling is the default behavior for both [com.jakewharton.mosaic.animation.Animatable] and [com.jakewharton.mosaic.animation.Transition]. Consider
 * using those APIs for the interruption handling, as well as built-in animation lifecycle
 * management.
 *
 * @param animationSpec the [com.jakewharton.mosaic.animation.AnimationSpec] that will be used to calculate value/velocity
 ...
 * @param typeConverter the [com.jakewharton.mosaic.animation.TwoWayConverter] that is used to convert animation type [T] from/to [V]
 */
 ...
 * management.
 *
 * @param animationSpec the [com.jakewharton.mosaic.animation.VectorizedAnimationSpec] that will be used to calculate value/velocity
 * @param initialValue the start value of the animation
 * @param targetValue the end value of the animation
 * @param typeConverter the [com.jakewharton.mosaic.animation.TwoWayConverter] that is used to convert animation type [T] from/to [V]
 * @param initialVelocityVector the start velocity of the animation in the form of [AnimationVector]
 * @see [com.jakewharton.mosaic.animation.Transition]
 * @see [com.jakewharton.mosaic.animation.rememberTransition]
 * @see [com.jakewharton.mosaic.animation.updateTransition]
 * @see [com.jakewharton.mosaic.animation.Animatable]
 */
...
internal constructor(
	 ...
	 * __Note__: When interruptions happen to the [TargetBasedAnimation], a new instance should be
	 * created that use the current value and velocity as the starting conditions. This type of
	 * interruption handling is the default behavior for both [com.jakewharton.mosaic.animation.Animatable] and [com.jakewharton.mosaic.animation.Transition].
	 * Consider using those APIs for the interruption handling, as well as built-in animation
	 * lifecycle management.
	 *
	 * @param animationSpec the [com.jakewharton.mosaic.animation.AnimationSpec] that will be used to calculate value/velocity
	 * @param typeConverter the [com.jakewharton.mosaic.animation.TwoWayConverter] that is used to convert animation type [T] from/to
	 *   [V]
	 * @param initialValue the start value of the animation
	 * @param targetValue the end value of the animation
 ...
 * [com.jakewharton.mosaic.animation.Animatable.animateDecay], [com.jakewharton.mosaic.animation.animateDecay], etc.
 *
 * @see com.jakewharton.mosaic.animation.Animatable.animateDecay
 * @see com.jakewharton.mosaic.animation.animateDecay
 */
...
constructor(
	...
	@get:Suppress("MethodNameUnits")
	override val durationNanos: Long =
		animationSpec.getDurationNanos(initialValueVector, initialVelocityVector)
